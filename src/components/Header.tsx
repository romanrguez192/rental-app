...
export default function WithSubNavigation() {
  ...
  return (
    <Box as="header" pos="sticky" top={0}>
      <Flex
        ...
        justify="center"
      >
        <Flex flex="1" align="center" maxW="1400px">
          ...
          <Flex flex={1} align="center" justify={{ base: "center", md: "start" }}>
            <Image src="/logo.svg" alt="logo" width="40" height="31.2" />
            <Link
              ml={4}
    ...
    <Stack direction="row" spacing={4}>
      {NAV_ITEMS.map((navItem) => (
        <Box key={navItem.label}>
          <Popover trigger="hover" placement="bottom-start" id="popover-fix">
            <PopoverTrigger>
              <Link
                p={2}
                href={navItem.href}
